...
# * https://github.com/samwhelp/note-about-grub/blob/gh-pages/_demo/project/grubrc-profile/grubrc-theme-get/remote-install.sh
# * https://github.com/samwhelp/note-about-grub/blob/gh-pages/_demo/project/grubrc-profile/grubrc-theme-get/grubrc-theme-get
# * https://raw.githubusercontent.com/samwhelp/note-about-grub/gh-pages/_demo/project/grubrc-profile/grubrc-theme-get/grubrc-theme-get
...
## $ export DEBUG_GRUBRC_THEME_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_GRUBRC_THEME_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="grubrc-theme-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-grub/blob/gh-pages/_demo/project/grubrc-profile/grubrc-theme-get/grubrc-theme-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-grub/gh-pages/_demo/project/grubrc-profile/grubrc-theme-get/grubrc-theme-get'


	THE_TARGET_FILE_NAME="grubrc-theme-get"
