...
base_var_init () {
	...
	THE_GRUBRC_DIR_PATH="/boot/$THE_GRUBRC_DIR_NAME"

	THE_GRUBRC_THEMES_DIR_NAME="themes"
	THE_GRUBRC_THEMES_DIR_PATH="$THE_GRUBRC_DIR_PATH/$THE_GRUBRC_THEMES_DIR_NAME"

	THE_GRUBRC_MASTER_CONFIG_FILE_NAME="grub"
	THE_GRUBRC_MASTER_CONFIG_FILE_PATH="/etc/default/$THE_GRUBRC_MASTER_CONFIG_FILE_NAME"
	THE_GRUBRC_MASTER_CONFIG_TEMP_FILE_PATH="/tmp/$THE_GRUBRC_MASTER_CONFIG_FILE_NAME"

	THE_GRUBRC_MASTER_CONFIG_BASE_BACKUP_DIR_PATH="$HOME/.backup"
	THE_GRUBRC_MASTER_CONFIG_BACKUP_DIR_PATH="$THE_GRUBRC_MASTER_CONFIG_BASE_BACKUP_DIR_PATH"
	THE_GRUBRC_MASTER_CONFIG_BACKUP_FILE_PATH="$THE_GRUBRC_MASTER_CONFIG_BACKUP_DIR_PATH/$THE_GRUBRC_MASTER_CONFIG_FILE_NAME"
